...
public class InformacionEquipoTecnico extends javax.swing.JFrame {
    ...
    public InformacionEquipoTecnico() {
        idEquipo = GestionarEquipos.idEquipoUpdate;
    ...
    private void initComponents() {
        ...
        txtPaneObservaciones.setEditable(false);
        ...
        botonActualizar.setText("Comentar y Actualizar");
    ...
    private void botonActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonActualizarActionPerformed
        ...
        String revision_tecnica_de = user;
        String comentarios_tecnico = txtPaneComentarioTecnico.getText();
        ...
        if (var == 0) {
            try {
                ...
                String Query = "update equipos set tipo_equipo=?, marca=?, modelo=?, num_serie=?,observaciones=?,"
                        + "estatus=?,ultima_modificacion=?,comentarios_tecnico=?,revision_tecnica_de=? where id_equipo = '" + idEquipo + "'";
                PreparedStatement pst = con.prepareStatement(Query);
                ...
                pst.setString(8, comentarios_tecnico);
                pst.setString(9, revision_tecnica_de);
                pst.executeUpdate();
                ...
                labelNombreTecnico.setText("Comentarios y actualización del técnico: " + user);
